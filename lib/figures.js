...
(function (root) {
  ...
  function drawBody(canvas, value, gender) {
    ...
    ctx.beginPath();
    ctx.moveTo(cx - 6, yS - 5);
    ctx.bezierCurveTo(cx - 13, yS - 6, cx - sh + 5, yS - 3, cx - sh, yS + 4);
    ctx.bezierCurveTo(cx - bust, yB - 6, cx - waist, yW - 4, cx - hip, yH);
    ...
    ctx.bezierCurveTo(cx + waist, yW - 4, cx + bust, yB - 6, cx + sh, yS + 4);
    ctx.bezierCurveTo(cx + sh - 5, yS - 3, cx + 13, yS - 6, cx + 6, yS - 5);
    ctx.closePath();
    ...
    ctx.beginPath(); ctx.moveTo(cx - 5, yS - 5); ctx.lineTo(cx - 4, top + 21);
    ctx.moveTo(cx + 5, yS - 5); ctx.lineTo(cx + 4, top + 21); ctx.stroke();
