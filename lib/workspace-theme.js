...
(function () {
  ...
  var themeColors = { midnight: '#101925', 'white-base': '#edf1f5', archangel: '#f7f8fa', musai: '#121a14', rewloola: '#1c141b',
    agama: '#f3efe4', ptolemaios: '#0d1d25', isaribi: '#1d1710', spartan: '#12171b' };
  var viewportFrame = 0;
