  ...
  return html`<div class="appearance-controls">
    <label><span class="theme-dot" aria-hidden="true"></span>테마
      <select aria-label="테마" value=${appearance.theme}
        ...
        <option value="rewloola">레우르라</option>
        <option value="agama">아가마</option>
        <option value="ptolemaios">프톨레마이오스</option>
        <option value="isaribi">이사리비</option>
        <option value="spartan">스파르탄</option>
      </select>
    </label>
    <label>화면 밀도
...
const FLEET_MARK = {
  ...
  /* 무어 동포단 — 장갑화한 뱃머리와 좌우 쌍열 포문 */
  spartan: [
    ['M8 14 24 5l16 9-4 20-12 11-12-11Z', 'line'],
    ['M15 18h18l-2 14-7 6-7-6Z', 'line'],
    ['m24 9 5 8-5 5-5-5Z', 'fill'],
    ['M11 27h7m12 0h7', 'signal'],
  ],
