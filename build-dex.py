...
.row .lnk{margin-top:6px}
.row .lnk a{color:#8FB4D9;font-size:11px;text-decoration:none}
.row .lnk a:hover{text-decoration:underline}
...
function open(n,start){
  ...
  function body(){
    ...
    if(!s)h+='<div class="sec">그림</div><p style="color:var(--dim);font-size:13px">'+
      '아직 그림이 없는 카드다.</p>';
    return h;
  }
