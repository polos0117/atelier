...
ALIAS_MECH = {
    ...
    # 공식 표기와 저장소 표기가 갈려 같은 기체가 두 장이 되었던 것들.
    # 손질해 둔 쪽을 남기고 반입분은 지웠으니 공식 이름은 이리로 보낸다.
    "건담 칼리번": "건담 캘리번",
    "윙 건담 0": "윙 건담 제로 EW",
    "건담 DX": "더블 엑스",
    "유니콘 건담 3호기 페넥스": "페넥스",
    "리본즈 건담/리본즈 캐논": "리본즈 건담",
    "고트라탄": "고틀라탄",
    "리그 샷코": "리그 샤코",
    "샷코": "샤코",
    "키케로가 [MS 형태]": "키케로가",
...
PERSON = {"람바랄": "란바랄", "화유이리": "파유이리", "케리레즈너": "켈리레즈너",
          ...
          "포무라사메": "포우", "그레미토토": "글레미", "웃소에빈": "우소에빈",
          # SEED/DESTINY 쪽은 공식이 로마자로만 적어 둔 항목이 섞여 있다.
          "kirayamato": "키라야마토", "shinnasuka": "신아스카",
          "lunamariahawke": "루나마리아호크", "yzakjule": "이자크쥴",
          "dearkaelthman": "디아카앨스먼", "athrunzala": "아스란자라"}
